...
if(isset($_POST["sbbtn"])) {
    ...
    $insert_query = "INSERT INTO feedbacks (email, name, message) VALUES ('".$_SESSION['provider_emailid']."', '".$_SESSION['provider_name']."', '$mm')";
                                ...
                                <form method="post" action="">
                                    <div class="row gtr-uniform">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="email" name="emailid" id="emailid" value="<?php echo htmlspecialchars($_SESSION['provider_emailid']); ?>" readonly required />
                                        </div>
                                        <div class="col-12">
                                            <label>Name:</label>
                                            <input type="text" name="nm" id="nm" value="<?php echo htmlspecialchars($_SESSION['provider_name']); ?>" readonly required />
                                        </div>
                                        <div class="col-12">
                                            <label>Message:</label>
