                    ...
                    <div class="features" >
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $query = "SELECT 
                                ...
                                p.phnno, p.email, p.photo, 
                                vr.specification, vr.estd_date, vr.certificate_pic, p.average_rating
                            FROM 
                                provider p
                            JOIN 
                            ...
                            if ($stmt->num_rows > 0) {
                                $stmt->bind_result($pid, $fname, $mname, $lname, $dob, $gender, $country, $state, $city, $address, 
                                                   $phnno, $email, $photo, $specification, $estd_date, $certificate_pic, $rating);
                                ...
                                while ($stmt->fetch()) {
                                    ...
                                    echo ' <span>(' . number_format($rating, 2) . ')</span>';
                                    echo '</div>';
                                    ...
                                    echo '</p>';
                                    echo '<p align="center">';
                                    echo '<a href="service_booking.php?pid=' . $pid . 
